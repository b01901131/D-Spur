...
float L1, L2, L3; //length of arm between joints
//Shoulder to elbow length
//Elbow    to wrise length
//Wrist    to hand  length
...
// Solve angles!
bool solve(float x, float y, float z, float& cmd0, float& cmd1, float& cmd2, float& cmd3, float cmd4)
{
    // Solve top-down view
    float r, th0;
